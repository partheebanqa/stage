...
public class ApiHeader {
	public static TestDataFactory testdata = new TestDataFactory();
        ...
        for (String header : headers) {
            switch (header) {
                ...
                case "Vary":
            	    		...
            	    		break;
                case "access-token":
	    				builder.addCookie("access-token",testdata.getAccess_token());	
	    				break;
                case "client":
    					builder.addCookie("client",testdata.getClient());	
    					break;     
                case "uid":
    					builder.addCookie("uid",testdata.getUid());	
    				break;                	 
